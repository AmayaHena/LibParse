...
namespace fileManager {
    ...
    class ParserFile {
        ...
        public:
            ...
            /* Scearch Tool */
            std::string findStr(std::string s, File f, unsigned int i = 0);
            std::string findStr(std::string s, std::vector<std::string> v, unsigned int i = 0);
        ...
        private:
            ...
            std::string find(std::string &s, std::vector<std::string> v, unsigned int i);
